...
// these method below is only for unit test
    ...
    private static void testMove2() throws Exception{
    	...
    	Field field_cache = ArrayLRUCache.class.getDeclaredField("cache");
    	field_cache.set(instance, new User[]{new User(0, "0"), new User(1, "1"), null});
    	
    	Method method_move = ArrayLRUCache.class.getDeclaredMethod("move", int.class);
    	method_move.invoke(instance, 1);
    	
    	User[] source = (User[]) field_cache.get(instance);
    ...
    private static void testMove3() throws Exception {
    	...
    	ArrayLRUCache instance = new ArrayLRUCache(3);
    	Field field_cache = ArrayLRUCache.class.getDeclaredField("cache");
    	field_cache.set(instance, new User[]{new User(0, "0"), new User(1, "1"), new User(2, "2")});
    	
    	Method method_move = ArrayLRUCache.class.getDeclaredMethod("move", int.class);
    	method_move.invoke(instance, 1);
    	
    	User[] source3 = (User[]) field_cache.get(instance);
